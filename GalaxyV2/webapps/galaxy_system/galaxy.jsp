...
<TABLE border="1" cellpadding="0" cellspacing="0" bordercolor="gray">
  <TBODY>
    <TR>
	  <TD valign="middle" align="center" width="800" height="20" bgcolor="gray">
	  	<B><FONT size="+2" color="#ffff00">Galaxy Type Neo</FONT></B>
	  </TD>
	</TR>
	<TR>
	...
	<TR>
		<TD valign="middle" align="center" width="800" height="20" bgcolor="gray">
			...
			<A href="../list.html" target=_blank>データベース</A>
			<A href="../manual.html" target=_blank>マニュアル</A>
			<A href="printinfo.html" target=_blank>プリント</A>
		</TD>
	</TR>
  </TBODY>
</TABLE>
