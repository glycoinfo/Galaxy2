...
<TITLE>GALAXY SYSTEM Version1</TITLE>
...
<P align="center"><B><FONT size="+3">Galaxy システム 1</FONT></B></P>
<P align="center"><IMG src="image/beau_l2.gif" width="685" height="3" border="0"><BR>
</P>
<P align="center"><A class="lnk" href="javascript:winopen('SYSTEM1','width=900,height=675,menubar=yes,scrollbars=yes,resizable=yes,location=no');"><IMG src="image/start.png" width="191" height="42" border="0" alt="GALAXY : Glycoanalysis by the three-axes of MS and chromatography."></A><BR><BR><BR>
